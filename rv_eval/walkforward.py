...
Usage:
    python -m rv_eval.walkforward                                   # default HAR reference
    python -m rv_eval.walkforward --model rv_eval.model_contract:HARX --universe clean_core
    python -m rv_eval.walkforward --benchmarks --universe clean_core   # all reference models
"""
...
from rv_eval.model_contract import BENCHMARKS, Model
...
def main() -> None:
    ...
    ap.add_argument("--model", default="rv_eval.model_contract:HARReference")
